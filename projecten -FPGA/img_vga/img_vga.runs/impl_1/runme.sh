...
HD_PWD='C:/Users/andre/OneDrive - AP Hogeschool Antwerpen/school 2021-2022/dsd/img_vga/img_vga.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log VGA_smiley_top.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source VGA_smiley_top.tcl -notrace
